...
public class SalaKinowa {
    ...
    public SalaKinowa(String fileName, String login, ArrayList<String> daneFilmu){ //konstruktor
        this.login = login;
        this.daneFilmu = daneFilmu;
        this.filename = fileName;  //dane nazwy pliku, w ktorym przechowywane sa stany miejsc


        final JFrame frame = new JFrame("Rezerwacja Mijesc"); //frame
        ...
        zatwierdz.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                if (zaznaczone.size() - wczytajIleZaznaczonych() != 0) {
                    RezerwujGUI nowy = new RezerwujGUI(zaznaczone, filename, login, daneFilmu);
...
//        panel2.setLocation(0, 0);
    ...
    public static void main(String[] args) {
        ...
        daneFilmu.add("test");
        daneFilmu.add("test");
        new SalaKinowa("src\\dane\\test_siedzen.csv", "test", daneFilmu);
    }
}