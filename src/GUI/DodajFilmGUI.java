...
public class DodajFilmGUI {
    ...
    public DodajFilmGUI(String login) {
        ...
        dodajButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                else JOptionPane.showMessageDialog(null, "wszystkie pola muszą być wypełnione", "DodajKlientaGUI", JOptionPane.PLAIN_MESSAGE);
            }
        });
    ...
    public void generujSale(int i){
        try {
            ...
            File myObj = new File("src\\dane\\filmy_sale\\"+fileName);
            File template = new File("src\\dane\\template.txt");
